...
public class TestDatabaseStub
{
	...
	@Test
	public void testHasLibrary()
	{
		// Create a new DatabaseStub object, hasLibrary method should return false because it is empty.
		DatabaseStub databaseStub_temp = new DatabaseStub();
	...
	public void testGetSongsFromArtist()
	{
		...
		assert (listForTest.get(0).getArtist().equals("artist1") && listForTest.get(0).getURI().equals("uri1"));
		assert (listForTest.get(1).getArtist().equals("artist1") && listForTest.get(1).getURI().equals("uri4"));
		assert (listForTest.get(2).getArtist().equals("artist1") && listForTest.get(2).getURI().equals("uri6"));
	}
	...
	public void testGetSongsFromAlbum()
	{
		...
		assert (listForTest.size() == 3);
		assert (listForTest.get(0).getAlbum().equals("album1") && listForTest.get(0).getURI().equals("uri1"));
		assert (listForTest.get(1).getAlbum().equals("album1") && listForTest.get(1).getURI().equals("uri5"));
		assert (listForTest.get(2).getAlbum().equals("album1") && listForTest.get(2).getURI().equals("uri6"));
	}

	@Test
	public void testGetSong_String()
	{
		...
		assert (listForTest.get(0).getName().equals("title1") && listForTest.get(0).getURI().equals("uri1"));
		assert (listForTest.get(1).getName().equals("title1") && listForTest.get(1).getURI().equals("uri2"));
	}

	@Test
	public void testGetSong_Int()
	{
